...
import os
class Exp5_real_data_dataset_varying_the_training_data_size:
    ...
    def exp_5_my_solution(self,dir_mysolu, drone_capacity, step_size,  dataset, sensor_map,
                           hovering_energy_per_unit, flying_energy_per_unit, maximum_number_of_training_data,
                           num_of_estimation_data, exp5_my_solu_plotter,size_data_collection, drone_commu_rate,
        ...
        num_training_data_list=range(200, maximum_number_of_training_data, step_size)
        with open('%spath_plan_mysolution.txt' %(dir_mysolu), 'w') as f:
            ...
            tour_id=0
            for number_of_training_data in num_training_data_list:
                ...
                f.write('***************************************************************\n')
                f.write('num_of_training_date %d \n' %(number_of_training_data))
                f.write('vars_rank: %s \n' %(vars_rank))
                ...
                if len(tour) != 0:
                    exp5_my_solu_plotter.plot_tour_map(sensor_map, tour, tour_id, optimal_dis, optimal_cost)
                    tour_id += 1
            averaged_mse_varying_drone_capabilities = np.average(mse_along_time_total, axis=1)
            exp5_my_solu_plotter.plot_averaged_mse_vary_drone_capability(num_training_data_list,
                                                                 averaged_mse_varying_drone_capabilities,
                                                                 expected_mse_list)
            exp5_my_solu_plotter.plot_selected_sensors_vary_drone_capability(num_training_data_list, num_of_selected_nodes)
            exp5_my_solu_plotter.plot_tour_length_vary_drone_capability(num_training_data_list, optimal_dis_list)
            exp5_my_solu_plotter.plot_energy_cost_vary_drone_capability(num_training_data_list, optimal_energy_cost_list)
    ...
    def exp5_ML_baseline(self, dir_baseline_ml, drone_capacity, step_size,  dataset, sensor_map, hovering_energy_per_unit, flying_energy_per_unit, maximum_number_of_training_data, num_of_estimation_data, exp5_baseline_plotter, size_data_collection, drone_commu_rate,
                          mse_file_name, sensor_length_file_name, uav_speed, uav_unit_time_uav_operation_cost):
        mse_list_total = []
        num_of_selected_nodes = []
        optimal_dis_list = []
        optimal_energy_cost_list = []
        num_of_training_data_list = range(200, maximum_number_of_training_data, step_size)
        with open('%spath_plan_baseline_ml.txt' % (dir_baseline_ml), 'w') as f:
            f.write(
                'Path Plan with different drone capabilities\n')  ## track the trajectory planned for each drone capacity
            tour_id = 0
            for number_of_training_data in num_of_training_data_list:
                drone = Drone.Drone(drone_capacity, hovering_energy_per_unit, flying_energy_per_unit, drone_commu_rate, uav_speed, uav_unit_time_uav_operation_cost)
                ...
                if len(optimal_tour) != 0:
                    exp5_baseline_plotter.plot_tour_map(sensor_map, optimal_tour, tour_id, optimal_distance, optimal_cost)
                tour_id += 1
        ...
        #                                                              total_mse_list_for_all_ML_models_varying_drone_capability)
                ...
                if len(optimal_tour) != 0:
                    exp5_baseline_plotter.plot_tour_map(sensor_map, optimal_tour, tour_id, optimal_distance, optimal_cost)
                    tour_id += 1
            exp5_baseline_plotter.plot_mse_with_varying_drone_capabilities(num_of_training_data_list, mse_list_total)
            exp5_baseline_plotter.plot_selected_sensors_vary_drone_capability(num_of_training_data_list, num_of_selected_nodes)
            exp5_baseline_plotter.plot_tour_length_vary_drone_capability(num_of_training_data_list, optimal_dis_list)
            exp5_baseline_plotter.plot_energy_cost_vary_drone_capability(num_of_training_data_list, optimal_energy_cost_list)
    ...
    def exp5_FS_baseline(self,dir_baseline_fs, drone_capacity, step_size, dataset, sensor_map,
                              hovering_energy_per_unit, flying_energy_per_unit, maximum_number_of_training_data,
            ...
            for number_of_training_data in num_training_data_list:
                ...
                if len(optimal_tour) != 0:
                    exp3_baseline_fs_plotter.plot_tour_map(sensor_map, optimal_tour, tour_id, optimal_distance,
                                                        optimal_cost)
                    tour_id += 1
            exp3_baseline_fs_plotter.plot_mse_with_varying_drone_capabilities(num_training_data_list, mse_list_total)
            exp3_baseline_fs_plotter.plot_selected_sensors_vary_drone_capability(num_training_data_list, num_of_selected_nodes)
            exp3_baseline_fs_plotter.plot_tour_length_vary_drone_capability(num_training_data_list, optimal_dis_list)
            exp3_baseline_fs_plotter.plot_energy_cost_vary_drone_capability(num_training_data_list, optimal_energy_cost_list)
    ...
    def exp_5(self, dir_exp5):
        #todo run_exp3 and check the results
        # This set of experiments varying the training dataset size
        ## read the parameters of exp3
        path_sensor_map = self.config['Exp_5']['dir_sensor_map']
        dir_dataset = self.config['Exp_5']['dir_dataset']
        dir_mysolu= self.config['Exp_5']['dir_mysolu']
        dir_baseline_ml = self.config['Exp_5']['dir_baseline_ml']
        dir_baseline_fs = self.config['Exp_5']['dir_baseline_fs']
        budget =int(self.config['Exp_5']['budget'])
        maximum_number_of_training_data = int(self.config['Exp_5']['maximum_num_of_training_data'])
        step_size = int(self.config['Exp_5']['step_size'])
        ...
        num_of_estimation_data= int(self.config['Exp_5']['num_of_estimation_data'])
        size_data_collection = int(self.config['Exp_5']['size_data_collection'])
        drone_commu_rate = int(self.config['Drone']['comm_rate'])
        mse_file_name = self.config['Exp_5']['mse_file_name']
        sensor_length_file_name=self.config['Exp_5']['sensor_length_file_name']
        ...
        self.plotter = plotter.plotter(dir_exp5)
        ...
        # exp5_my_solu_plotter = plotter.plotter(dir_mysolu+'/')
        #
        # self.exp_5_my_solution(dir_mysolu+'/', budget, step_size,  dataset, sensor_map, hovering_energy_per_unit, flying_energy_per_unit, maximum_number_of_training_data, num_of_estimation_data, exp5_my_solu_plotter,size_data_collection,
        ...
        # self.exp5_ML_baseline(dir_baseline_ml+'/', budget, step_size,  dataset, sensor_map,
        #                       hovering_energy_per_unit, flying_energy_per_unit, maximum_number_of_training_data, num_of_estimation_data,
        ...
        # self.exp5_FS_baseline(dir_baseline_fs+'/', budget, step_size, dataset, sensor_map,
        #                       hovering_energy_per_unit, flying_energy_per_unit, maximum_number_of_training_data,
        #                       num_of_estimation_data, exp3_baseline_fs_plotter, size_data_collection, drone_commu_rate,
        #                       mse_file_name, sensor_length_file_name, uav_speed, uav_unit_time_uav_operation_cost)
        ...
        mse_metric= self.config['Exp_5']['mse_matric_name']
        selected_sensor_metric=self.config['Exp_5']['selected_sensor_matric_name']

        #make the final plot of the metric with three solutions
        matrics = [mse_metric, selected_sensor_metric]
        num_training_data_list=np.arange(200, maximum_number_of_training_data,step_size)
        mse_avgs = {}
        num_sensor_avgs = {}
        ...
        self.plotter.plot_MSE_with_all_solutions_real_dataset_exp5(num_training_data_list, mse_avgs)
        self.plotter.plot_number_of_sensor_selected_with_all_solutions_real_dataset_exp5(num_training_data_list, num_sensor_avgs)
