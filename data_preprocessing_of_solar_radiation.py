...
# with open('Dataset/solar_radiation_dataset/Solar_Radiatio       n_sensor_map', 'r') as file:
#     for line in file:
...
# plt.show()
#
# file_path = 'Dataset/solar_radiation_dataset/DataMatrix_315.txt'
...
#plot the cov metrix.
data=np.loadtxt("Dataset/solar_radiation_dataset/DataMatrix_315.txt")
#cov_matrix=np.cov(data)
corr_matrix=np.corrcoef(data.T)

np.savetxt('Dataset/solar_radiation_dataset/correlation_matrix_315.csv', corr_matrix, delimiter=',')
#print(cov_matrix)
print(corr_matrix)
