...
class Exp1:
    ...
    def generate_synthetic_data(self):
        ...
        dataset=np.loadtxt('Dataset/solar_radiation_dataset/DataMatrix_319.txt')
        cluster1=dataset[:, :4]
        ...
        np.savetxt('Dataset/sensor_maps/dataset_map_2_DataMatrix_319.txt', synthetic_dataset)
